...
| Skip offscreen pages while scrolling | off | Applies `content-visibility: auto` to old pages in long sessions, so the browser skips rendering them. Wrapped mode only. |
